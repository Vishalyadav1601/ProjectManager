...
public class JWTTokenHelper {
    ...
    //3. According to JWS Compact serialization(https://tools.ieif.org/html/draft0ief-jose--json-web-signature-41#section-3.1)
    // compaction fo the JWT to a URL-safe string
